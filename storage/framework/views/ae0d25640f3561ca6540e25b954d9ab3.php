        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(url('categories/create')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="detail" class="form-control" rows="5"><?php echo e(old('description')); ?></textarea>
                                <?php $__errorArgs = ['detail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="detail"><?php echo e($message); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="checkbox" name="is_done" <?php echo e(old('is_') ? 'checked' : ''); ?> />
                                <?php $__errorArgs = ['is_done'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="is_done"><?php echo e($message); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\app\todolist\resources\views/category/create.blade.php ENDPATH**/ ?>